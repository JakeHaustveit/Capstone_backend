...
from .views import  RegisterView, UserDetail, UserList, EmployeeRegisterView, OwnerDetails, EmployeeDetails, EmployeeList
...
urlpatterns = [
    ...
    path('employeelist/<str:name>', EmployeeList.as_view()),
